Method 1: **broken**
(see [live_reloader.rs](method1/src/live_reloader.rs))
...
Method 4: props to David Jobet on Zulip for this method - press F5 to see changes. must replace <REPO_DIRECTORY> in order for this to work
